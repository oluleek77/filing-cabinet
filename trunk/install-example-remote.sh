...
rsync -rl --exclude='*/.svn' index.html common.php upload_files.php uploader.php qquploader.php add-file.php listview.php fileview.php access.class.php login.php register.php download.php labelserver.php mime_type_lib.php images js css $full_path/
